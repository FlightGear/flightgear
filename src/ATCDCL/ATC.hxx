...
protected:
    ...
    void Render(string& msg, const double volume = 1,
        const string& refname = "", const bool repeating = false);
    ...
    bool _display;      // Indicates we should be outputting to the ATC display.
...
// This code parallels code found in fgAirportDBLoad(...) in apt_loader.cxx
