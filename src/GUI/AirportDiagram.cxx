...
void AirportDiagram::paintEvent(QPaintEvent* pe)
{
    ...
    // fit bounds within our available space
    double ratioInX = width() / m_bounds.width();
    double ratioInY = height() / m_bounds.height();
    ...
    if (ratioInX < ratioInY) {
        ...
        t.scale(ratioInX, -ratioInX);
    } else {
        // vertically constrained
        t.scale(ratioInY, -ratioInY);
    }
...
{
    m_pavements.clear();
    qDebug() << "pavments:" << m_airport->numPavements();
