...
{
public:
    WindowsModel(FGQQWindowManager* wm) :
        QAbstractListModel(wm)
    {
...
{
public:
    WindowManagerPrivate(FGQQWindowManager* outer) :
        _p(outer),
...
FGQQWindowManager::FGQQWindowManager(QQmlEngine *engine, QObject *parent) :
    QObject(parent),
